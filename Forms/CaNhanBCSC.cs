    ...
    public partial class CaNhanBCSC : Form
    {
        ...
        private void btnGui_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                sql = "INSERT INTO tblBaoCaoSuCo (MaBCSC, NgayBCSC, MaPM, MaNV, MoTaSC, HinhAnh, Trangthai, NgayXuLy) VALUES (N'" + maBCSC + "', N'" + ConvertDateTime(txtNgayBCSC.Text.Trim()) + "', N'" + cboPhongmay.SelectedValue + "', N'" + txtGiaovien.Text.Trim() + "', N'" + txtMota.Text.Trim() + "', N'" + txtAnhSuCo.Text.Trim() + "', N'0', NULL)";
